...
void gen_tables()
{
	...
	JPoint powG[256];
	size_t j = 0;
	JPoint T1 = zero_jacobian, T2 = zero_jacobian;
	size_t k = 0;
	...
	for (size_t i = 1; i < 256; i++)
	{
		...
		add_JPoint(powG[i - 1], powG[i - 1], powG[i]);
	}
